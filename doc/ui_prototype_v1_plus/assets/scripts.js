/* ============================================================
   ...
   Friendly AI learning flow: history, widgets, menu, follow-up
   ============================================================ */
...
const demoStates = {
  ...
  scene: {
    ...
    messages: [
      {
        type: 'system',
        text: 'Echo 正在根据你的年龄、年级、目标和薄弱点准备推荐。',
      },
      {
        type: 'ai',
          ...
          scenes: [
            {
              icon: '🍽',
              title: '餐厅点餐',
              desc: '练习 would like、一般疑问句和礼貌表达。',
              tags: ['B1', 'would like', '礼貌请求'],
              selected: true,
            },
            {
              icon: '🏫',
              title: '校园对话',
              desc: '围绕作业、社团和老师沟通，训练一般现在时。',
              tags: ['A2-B1', '情态动词', '一般现在时'],
            },
            {
              icon: '🧭',
              title: '旅行问路',
              desc: '练习 there be、介词搭配和宾语从句语序。',
              tags: ['A2', '介词', '语序'],
            },
            {
              icon: '📚',
              title: '图书馆借书',
              desc: '训练 can/could、到期归还和礼貌请求。',
              tags: ['A2', 'can/could', '日常表达'],
            },
          ],
        },
  ...
  practice: {
    ...
    messages: [
      {
        type: 'ai',
        text: '我们来练“餐厅点餐”。场景是：你在一家小餐馆点牛排套餐，需要说明熟度和配菜。',
      },
      {
        type: 'ai',
  ...
  grade: {
    ...
    messages: [
      {
        type: 'user',
        text: 'I want a medium steak with fries and salad.',
        label: '你的答案',
      },
      {
        type: 'ai',
      ...
      {
        type: 'ai',
        text: '如果你想追问某个点，我会在右侧打开辅助追问。主线练习会保持在这里，不会被带偏。',
      },
    ],
  },
  ...
  explain: {
    ...
    messages: [
      {
        type: 'user',
        text: '为什么点餐不能说 I want？',
      },
      {
        type: 'ai',
        text: '不是不能说，而是语气偏直接。点餐时你是在向服务员提出请求，英语里常用更柔和的 “I’d like…” 或 “Could I have…”。',
        widget: {
          type: 'choice-list',
          title: '更自然的替换',
          choices: [
            ['直接', 'I want a medium steak.'],
            ['自然', "I'd like a medium steak, please."],
            ['更礼貌', 'Could I have a medium steak, please?'],
          ],
        },
        actions: [
          { label: '举 3 个例句', toast: '已生成 3 个点餐语气替换例句。' },
          { label: '继续练习', state: 'practice' },
          { label: '结束并复盘', state: 'review' },
        ],
      },
    ],
  },
    ...
    messages: [
      {
        ...
        widget: {
          ...
          target: 'Could I have a quieter room, please?',
          tags: ['礼貌表达', '冠词', '酒店入住'],
        },
        actions: [
  ...
  menu: {
    ...
    messages: [
      {
        type: 'system',
        text: '学习菜单从输入框左侧打开，用来快速选择下一步，不需要记住任何特殊写法。',
      },
      {
        type: 'ai',
    ...
    messages: [
      {
        type: 'ai',
        meta: 'Echo · 辅助追问',
        text: '这里适合临时问一个句子、单词、错题、语法点、推荐答案或场景设定。主线练习会保持不变。',
      },
    ],
  },
  scene: {
    ...
    messages: [
      {
        type: 'ai',
        meta: 'Echo · 场景解释',
        text: '我推荐“餐厅点餐”是因为它能自然覆盖 would like、可数名词冠词和礼貌请求，而且题目长度适合初三学生。',
      },
      {
        type: 'user',
        meta: '你',
        text: '如果换成旅行场景，还能练同样的问题吗？',
      },
      {
        type: 'ai',
        meta: 'Echo',
        text: '可以。旅行问路会更偏介词和语序，礼貌请求也会出现，比如 “Could you tell me where the station is?”。',
      },
    ],
  },
  grammar: {
    ...
    messages: [
      {
        type: 'ai',
        meta: 'Echo · 题目解释',
        text: '这道题的关键不是 “steak” 这个词，而是 “would like to + 动词原形”。所以空里应填 order。',
      },
      {
        type: 'ai',
        meta: 'Echo',
        text: '如果你想问某个词，我也可以只围绕这道题里的 order、medium、steak 做解释。',
      },
    ],
  },
  politeness: {
    ...
    messages: [
      {
        type: 'ai',
        meta: 'Echo · 批改解释',
        text: '“I want” 语法没错，但在服务场景里像直接提出要求；“I’d like” 会把语气变成礼貌请求。',
      },
      {
        type: 'user',
        meta: '你',
        text: '那和 Could I have 有什么区别？',
      },
      {
        type: 'ai',
        meta: 'Echo',
        text: '“I’d like” 是自然点餐表达；“Could I have” 更像向对方请求许可，礼貌程度更高，也更适合第一次开口。',
      },
    ],
  },
  article: {
    ...
    messages: [
      {
        type: 'ai',
        meta: 'Echo · 语法解释',
        text: '这里的 salad 指“一份沙拉”，是可数名词短语，所以更自然的是 “a salad”。如果说泛指沙拉这种食物，才可能不用冠词。',
      },
    ],
  },
  review: {
    ...
    messages: [
      {
        type: 'ai',
        meta: 'Echo · 复盘解释',
        text: '你这轮的主要薄弱点是冠词和礼貌表达。下一轮我会优先生成“必须自然使用冠词和礼貌请求”的题。',
      },
      {
        type: 'ai',
        meta: 'Echo',
        text: '右侧辅助追问可以继续解释薄弱点，主学习流仍停留在复盘结果，方便你随时回到下一轮练习。',
      },
    ],
  },
};
...
const branchSource = document.getElementById('branchSource');
const branchMessages = document.getElementById('branchMessages');
const branchInput = document.getElementById('branchInput');
const sendBranch = document.getElementById('sendBranch');
...
function setComposerMode(mode) {
  ...
  menuPanel.classList.toggle('is-visible', mode === 'menu');
}
...
function renderFollowUpThread(threadName = 'default', options = {}) {
  ...
  branchInput.placeholder = thread.placeholder || '继续追问这个上下文...';
  branchMessages.scrollTop = branchMessages.scrollHeight;
  if (!options.silent) {
    showToast(`已打开辅助追问：${thread.sourceBadge.replace('来自：', '')}`);
  }
}
...
function renderWidget(widget) {
        ...
        <div class="scene-grid">
          ${widget.scenes.map(scene => `
            <button class="scene-card ${scene.selected ? 'is-selected' : ''}" type="button" data-action-state="practice">
              <div class="scene-icon">${escapeHtml(scene.icon)}</div>
        ...
        <div class="grading">
          ...
          <div class="compare-grid">
            <div class="compare-box">
              ...
              <div>${escapeHtml(widget.userAnswer)}</div>
            </div>
            <div class="compare-box">
              <div class="compare-label">参考表达</div>
              <div>${escapeHtml(widget.referenceAnswer)}</div>
            </div>
          </div>
  ...
  if (widget.type === 'choice-list') {
    return `
      <div class="widget">
        <div class="widget-head">
          <div>
            <h2 class="widget-title">${escapeHtml(widget.title)}</h2>
            <p class="widget-subtitle">同一个意思可以有不同语气，点餐时越柔和越自然。</p>
          </div>
          <span class="badge badge--coral">表达替换</span>
        </div>
        ${widget.choices.map(([label, sentence]) => `
          <div class="compare-box" style="margin-top: 8px;">
    ...
    return `
      <div class="widget">
        ...
        <div class="compare-grid" style="margin-top: 12px;">
          <div class="compare-box">
            <div class="compare-label">做得好</div>
            <div>${widget.strengths.map(escapeHtml).join(' · ')}</div>
          </div>
          <div class="compare-box">
            <div class="compare-label">还需加强</div>
            <div>${widget.weaknesses.map(escapeHtml).join(' · ')}</div>
          </div>
        </div>
...
function activateState(stateName, options = {}) {
  ...
  sessionTitle.textContent = state.title;
  flowBadge.textContent = state.flow;
  ...
  if (!options.silent) {
    showToast(`已切换：${state.flow.replace('当前：', '')}`);
  }
}

function bindDynamicActions() {
  messageList.querySelectorAll('[data-action-state]').forEach(btn => {
    btn.addEventListener('click', () => activateState(btn.dataset.actionState));
  });
  messageList.querySelectorAll('[data-action-follow-up]').forEach(btn => {
    btn.addEventListener('click', () => renderFollowUpThread(btn.dataset.actionFollowUp));
  });
  messageList.querySelectorAll('[data-action-mode]').forEach(btn => {
    btn.addEventListener('click', () => {
      setComposerMode(btn.dataset.actionMode);
      modeBadge.textContent = btn.dataset.actionMode === 'chat' ? '交互：自然对话' : '交互：选择';
      showToast('底部交互区已调整');
    });
  });
  messageList.querySelectorAll('[data-action-toast]').forEach(btn => {
...
document.querySelectorAll('[data-open-branch]').forEach(btn => {
...
document.querySelectorAll('[data-menu-state]').forEach(btn => {
  btn.addEventListener('click', () => {
...
document.querySelectorAll('[data-menu-toast]').forEach(btn => {
  btn.addEventListener('click', () => {
    menuPanel.classList.remove('is-visible');
...
activateState('onboarding', { silent: true });
